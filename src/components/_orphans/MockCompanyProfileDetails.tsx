...
/**
 * HUÉRFANO (código muerto preservado) — detalle MOCK del perfil del empresario:
 * proyectos inventados (DeFi/RAG/Fintech), historial de contratación falso
 * (Aether Dynamics…), cultura y redes hardcodeadas. Casi nada salía de la BD.
 * Reemplazado por `CompanyProfileDetails` (solo datos reales). Solo lo referencia
 * el otro huérfano `MockCompanyPerfilPage`. Conservado por decisión del equipo
